...
This is a Flash Card app created using React and Redux.

Followed instructions from [`reactjs/redux` docs](https://github.com/reactjs/redux/tree/master/docs/basics).

# Create-React-App Autogenerated
